$(document).ready(function() {
    ...
    function draw() {
        ...
        ctx.drawImage(backplate_img, popup_x, popup_y, backplate_img.width, backplate_img.height);
        ...
        var play_type_1 = ["퀘스트", "사냥", "수련", "수집", "잠수", "탐험", "미니게임", "스샷", "수다"];
        ...
        for (var etc_index in etc_talks) {
            ...
            ctx.fillText(etc_talks[etc_index], (popup_x + 160), (popup_y + 862) + 20 * etc_index)
        }
        ...
        for (now_index = 0; now_index < color_max; now_index++) {
            ...
            if (color_obj.name != "") {
                ctx.fillText(" · " + color_obj.name, (popup_x + 213 + 165 * x_ind), (popup_y + 553 + 60 * y_ind))
            }
            ctx.fillText(select_color_show, (popup_x + 225 + 165 * x_ind), (popup_y + 573 + 60 * y_ind))
        }
